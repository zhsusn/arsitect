...
### P-004：Checkpointer 状态持久化（v3.2 9.5）
...
### M-002：统计口径——Draft/Active 费用归属（v3.2 7.2）
...
### M-003：资源看板——Token/API 实时监控（v3.2 7.4）
