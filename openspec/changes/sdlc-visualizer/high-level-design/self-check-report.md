...
> 变更：sdlc-visualizer
> 关联文档：00-design-overview.md ~ 05-ops-governance.md
> 检查日期：2026-06-01
> 检查依据：`high-level-design` Skill Step 7.5 检查维度
...
### 1. 技术栈覆盖度（01-architecture-core ↔ 02-data-flow）
...
### 2. 架构-目录一致性（01-architecture-core）
...
### 3. 状态机-模块职责兼容性（03-runtime-behavior ↔ 02-data-flow）
...
### 4. 异常-回滚联动（03-runtime-behavior ↔ 05-ops-governance）
...
### 5. 性能-部署匹配（04-quality-attributes）
...
### 6. 安全-接口契约一致性（04-quality-attributes ↔ 02-data-flow）
...
### 7. ADR 溯源（01-architecture-core ↔ competitive-analysis.md / design-input.md）
...
### WARN-3：HTTPS 演进与 API 版本策略的兼容性未明确
