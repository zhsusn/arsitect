...
> **关联需求**：REQ-P0-016（规模评估）、REQ-P0-018（复杂度路由面板）、REQ-P0-027（模板偏离记录）  
> **关联用户故事**：US-007（评估项目规模）、US-011（查看复杂度路由面板）  
> **版本**：v1.0  
> **状态**：Draft
...
| 版本 | 日期 | 修改人 | 修改内容 |
|:----:|:----:|:-------|:---------|
| v1.0 | 2026-06-01 | AI PM | 初始版本，包含 5 个标准章节，覆盖 Triage 初估、Calibrate 精修、四级路径对比、降级确认、决策日志完整交互规格 |
