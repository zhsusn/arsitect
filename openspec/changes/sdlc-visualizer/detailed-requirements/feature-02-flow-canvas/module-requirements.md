...
> **模块编号**：DR-002  
> **模块名称**：SDLC 画布（SDLC Flow Canvas）  
> **关联需求**：REQ-P0-003、REQ-P0-004、REQ-P0-005、REQ-P0-007  
...
| 版本 | 日期 | 修改人 | 修改内容 |
|:----:|:----:|:-------|:---------|
| v1.0 | 2026-06-01 | AI PM | 初始版本，包含 5 个标准章节，覆盖 REQ-P0-003~005 及 REQ-P0-007 |
| v1.1 | 2026-06-04 | AI Dev | MVP 调整：① 画布 URL 简化为 `/canvas/{projectId}`；② 首次进入画布时后端根据 template_level 自动生成默认 Stage 节点与连线；③ 节点拖拽位置 3 秒防抖自动保存；④ 前端 404 时降级展示空画布 |
