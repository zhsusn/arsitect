---
doc_type: PRD
fragment_id: prd-sdlc-visualizer-864
title: Market Positioning — GTPlanner 六开源项目竞争分析
version: 1.0.0
...
### 1.1 直接竞品（Primary） {#sec-11-u76f4jieu7adeu54c1primary}
...
### 1.2 相邻扩展（Secondary） {#sec-12-xiangu90bbu6269u5c55secondary}
...
### 1.3 范式威胁（Non-obvious） {#sec-13-fanu5f0fu5a01u80c1nonobvious}
| 项目名称 | 协议 | 威胁向量 | 分析 |
|---------|------|---------|------|
...
### 1.4 隐性替代方案 {#sec-14-u9690xingu66ffdaiu65b9u6848}
| 替代方案 | 描述 | 威胁级别 |
|---------|------|---------|
...
## 2. JTBD 对比矩阵 {#sec-2-jtbd-duibiu77e9u9635}
...
## 3. Blue Ocean ERRC 分析 {#sec-3-blue-ocean-errc-fenxi}
### 3.1 剔除（Eliminate） {#sec-31-u5254chueliminate}
| 行业通用做法 | 剔除理由 | 证据 |
|-------------|---------|------|
...
### 3.2 减少（Reduce） {#sec-32-u51cfu5c11reduce}
| 行业过度服务的维度 | 减少方式 |
|-------------------|---------|
...
### 3.3 提升（Raise） {#sec-33-tishengraise}
| 维度 | 行业现状 | 本系统目标 |
|------|---------|-----------|
...
### 3.4 创造（Create） {#sec-34-chuangzaocreate}
| 新维度 | 描述 | 竞品覆盖 |
|--------|------|---------|
...
## 4. 颠覆向量与威胁景观（H1/H2/H3） {#sec-4-u98a0fuxiangliangyuu5a01u80c1j}
...
## 5. 战略建议（O→I→R→C→W） {#sec-5-u6218u7565jianu8baeoircw}
| 层级 | 内容 | 优先级 |
|------|------|--------|
...
## 6. 假设登记册 {#sec-6-u5047shedengjice}
| 假设 | 支撑框架 | 置信度 | 推翻条件 | 来源 |
|------|---------|--------|----------|------|
...
## 7. 对抗性自我批判 {#sec-7-duikangxingziu6211piu5224}
1. **无直接竞品可能是盲区**
...
### T4（行业报告） {#sec-t4xingyebaogao}
- SWE-bench 77%：OpenHands 官方性能数据

### T5（高管声明/项目文档） {#sec-t5u9ad8guanu58f0u660eu9879muwend}
