---
doc_type: TEST_PLAN
fragment_id: test-plan-sdlc-visualizer-356
title: UAT 执行指南：Arsitect SDLC Visualizer MVP
version: 1.0.0
...
## 1. 预览环境信息 {#sec-1-yulanu73afu5883xinxi}
| 项目 | 配置 |
|------|------|
...
### 1.2 环境重置方法 {#sec-12-u73afu5883chongzhiu65b9u6cd5}
若测试过程中数据污染，执行以下步骤重置：
...
## 2. 测试账号与权限 {#sec-2-ceshiu8d26haoyuquanxian}
...
## 3. 需重点关注的 P0 链路 {#sec-3-xuchongu70b9guanzhude-p0-u94fe}
...
## 4. 前端页面可用性说明 {#sec-4-u524du7aefyeu9762u53efyongxing}
...
## 5. 异常分支模拟指南 {#sec-5-yichangfenu652fmou62dfzhiu5357}
| 异常场景 | 模拟方法 | 观察要点 |
|----------|----------|----------|
...
## 6. 执行顺序建议 {#sec-6-zhixingu987axujianu8bae}
```
...
## 7. 问题反馈模板 {#sec-7-wentifankuimoban}
若在 UAT 过程中发现问题，请按以下格式记录：

```markdown
### 问题 {编号} {#sec-wenti-bianhao}
- **关联需求**：FR-XXX / US-XXX
- **严重级别**：🔴 P0 阻塞 / 🟡 P1 遗留
- **复现步骤**：
  1. ...
