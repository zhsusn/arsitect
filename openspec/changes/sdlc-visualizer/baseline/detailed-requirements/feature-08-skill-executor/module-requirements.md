...
title: 模块需求规格说明书：Skill 调度服务（Skill Executor Service）
version: 1.0.0
...
### 4.1 核心业务流程：PocketFlow 三阶段 {#sec-41-hexinyewuliuu7a0bpocketflow-s}
**阶段一：Prep（准备阶段）**
...
### 4.3 Skill 级状态机 {#sec-43-skill-jizhuangtaiji}
```mermaid
stateDiagram-v2
    [*] --> NOT_STARTED : 初始化
