...
title: DR-019 WireframeEngine — 模块级详细需求文档
version: 1.0.0
...
### 2.4 Mermaid 页面跳转图 {#sec-24-mermaid-yeu9762u8df3zhuantu}
```mermaid
flowchart LR
...
### 5.1 页面：Pg_001 线框图总览页 {#sec-51-yeu9762pg001-xianu6846tuzongl}
...
### 5.2 页面：Pg_002 单页线框图预览页 {#sec-52-yeu9762pg002-danyexianu6846tu}
...
### 5.3 页面：Pg_003 领域映射管理页 {#sec-53-yeu9762pg003-lingyuu6620u5c04}
...
### 5.4 页面：Pg_004 页面跳转关系图页 {#sec-54-yeu9762pg004-yeu9762u8df3zhua}
...
### 5.5 页面：Pg_005 页面类型配置页 {#sec-55-yeu9762pg005-yeu9762leixingpe}
...
### 5.6 页面间跳转关系图 {#sec-56-yeu9762jianu8df3zhuanguanxitu}
```mermaid
flowchart LR
    subgraph 总览域["总览域"]
