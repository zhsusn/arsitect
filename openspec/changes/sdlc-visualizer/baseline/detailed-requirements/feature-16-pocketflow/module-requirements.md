...
title: DR-016 PocketFlow 执行引擎（PocketFlow Execution Engine）
version: 1.0.0
...
### 3.4 接口响应字段（系统内部服务间） {#sec-34-jiekouu54cdyingu5b57u6bb5xito}
| # | 字段名 | 字段类型 | 说明 | 消费者 |
|:-:|:-------|:--------:|:-----|:-------|
...
### 5.1 页面：Skill 执行控制台（Pg_ExecConsole） {#sec-51-yeu9762skill-zhixingkongzhiu5}
...
### 5.2 页面：执行确认弹窗（Pg_ExecConfirm） {#sec-52-yeu9762zhixingquerentanchuang}
...
### 5.3 页面：产物详情页（Pg_ArtifactDetail） {#sec-53-yeu9762chanu7269xiangqingyepg}
...
### 5.4 页面间跳转关系图 {#sec-54-yeu9762jianu8df3zhuanguanxitu}
```mermaid
flowchart LR
