---
doc_type: "PRD"
fragment_id: "prd-sdlc-visualizer-885"
...
## 🔴 阻断级问题（0 项） {#sec-u963bu65adjiwenti0-u9879}
无阻断级问题。

---

## 🟡 警告级问题（23 项） {#sec-jinggaojiwenti23-u9879}
### W-001: AC 格式不一致 — ✅ 已修复 {#sec-w001-ac-u683cu5f0fbuyiu81f4-u5df}
| 模块 | AC 数量 | 问题描述 | 修复状态 |
|------|:-------:|----------|:--------:|
...
### W-002: Negative Criterion 缺失 — ✅ 已修复 {#sec-w002-negative-criterion-u7f3au59}
| 模块 | AC 总数 | 问题描述 | 修复状态 |
|------|:-------:|----------|:--------:|
...
### W-003: Dependency Criterion 缺失 — ✅ 已修复 {#sec-w003-dependency-criterion-u7f3au}
| 模块 | 问题描述 | 修复状态 |
|------|----------|:--------:|
...
### W-004: 术语大小写不一致 — ✅ 已自动修复 {#sec-w004-u672fu8bedu5927u5c0fu5199bu}
...
### W-005: Mermaid 语法违规 — ✅ 已自动修复 {#sec-w005-mermaid-u8bedu6cd5u8fddgui-}
...
### W-006: 模块头部元信息不完整 — ✅ 已自动修复 {#sec-w006-mokuaiu5934buu5143xinxibuwa}
| 模块 | 缺少字段 | 修复状态 |
|------|----------|:--------:|
...
## 🟢 提示级问题（6 项） {#sec-tiu793ajiwenti6-u9879}
### T-001: 假设登记册分散管理 {#sec-t001-u5047shedengjicefenu6563gua}
- 21 个模块各自维护假设注册表，未集中至单一事实来源
- **建议**：当前阶段可接受，P1 阶段考虑集中管理

### T-002: AC 数量分布不均 {#sec-t002-ac-shuliangfenbubuu5747}
...
### T-003: _consistency-report.md 中 Warning 未闭环 {#sec-t003-consistencyreportmd-zhong-w}
- 报告记录了 8 个 Warning，但尚未修复
- **建议**：在 Gate 2.5 前修复或确认下放

### T-004: 部分模块缺少 Mermaid 数据流转图 {#sec-t004-bufenmokuaiu7f3au5c11-merma}
- feature-08, feature-14 等模块的"输入输出字段"章节中数据流转图较简单
- **建议**：非阻塞，可在详细设计阶段补充

### T-005: 产物/Artifact 术语混用 — ✅ 已自动修复 {#sec-t005-chanu7269artifact-u672fu8be}
- 正文描述中的 "Artifact" 已统一替换为 "产物"
- 字段名中的 `artifact_xxx` 保持英文（标识符规范）
- **修复状态**：✅ 已完成

### T-006: 模块编号格式不统一 — ✅ 已自动修复 {#sec-t006-mokuaibianhaou683cu5f0fbuto}
- feature-03 版本号 "1.0.0" → "v1.0"
- **修复状态**：✅ 已完成

---

## 自动修复执行建议 {#sec-zidongxiufuzhixingjianu8bae}
以下 15 项警告可自动修复：
...
## 需人工确认项（10 项） {#sec-xurengongquerenu987910-u9879}
| 编号 | 内容 | 优先级 |
|------|------|:------:|
...
## 修复后重跑检查清单 {#sec-xiufuu540echongu8dd1jianchau6e05}
...
## 与 _consistency-report.md 的关系 {#sec-yu-consistencyreportmd-deguanxi}
