...
title: DR-003：阶段详情面板（Stage Detail Panel）
version: 2.1.0│
...
### 3.4 接口响应字段表（仅字段语义，无 API 规格） {#sec-34-jiekouu54cdyingu5b57u6bb5biao}
...
### 3.5 数据流转 Mermaid 图 {#sec-35-shujuliuzhuan-mermaid-tu}
```mermaid
flowchart TD
    subgraph 用户操作层
        U1[用户点击 Stage 节点]
...
### 5.2 页面间跳转关系 Mermaid 图 {#sec-52-yeu9762jianu8df3zhuanguanxi-m}
```mermaid
flowchart LR
    subgraph 入口
...
### B. 参考文档 {#sec-b-u53c2u8003wendang}
