...
title: DR-017 HITL 旁路审批服务 — 模块级详细需求文档
version: 1.0.0
...
### 3.4 接口响应字段（仅描述语义，不含技术规格） {#sec-34-jiekouu54cdyingu5b57u6bb5u4ec}
| 字段名 | 场景 | 说明 |
|--------|------|------|
...
### 4.3 状态机 — 旁路审批生命周期 {#sec-43-zhuangtaiji-u65c1lushenpishen}
```mermaid
stateDiagram-v2
    [*] --> 待授权: 提交申请
    待授权 --> 已授权: 授权人确认
...
### 5.3 全局交互规则 {#sec-53-quanu5c40jiaou4e92guize}
| 规则编号 | 规则描述 | 适用页面 |
|---------|---------|---------|
