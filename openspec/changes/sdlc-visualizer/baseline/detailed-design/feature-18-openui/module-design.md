...
title: DR-018：OpenUI 原型服务（OpenUI Prototype Service）模块详细设计
version: 1.0.0
...
> - `@C4-Interface:GET /api/v1/contracts/{project_id}`
> - `@C4-Interface:GET /api/v1/docker/status`
> - `@C4-Interface:GET /api/v1/openui/history`
> - `@C4-Interface:GET /api/v1/openui/status`
> - `@C4-Interface:POST /api/v1/openui-service/generate`
> - `@C4-Interface:POST /api/v1/openui/generate`
> - `@C4-Interface:POST /api/v1/openui/launch`
> - `@C4-Interface:PUT /api/v1/c4/dsl/{project_id}`
> - `@C4-L2-Container:frontend-spa`
> - `@C4-L3-Component:controlpanel`
> - `@C4-L3-Component:fallbackmanager`
> - `@C4-L3-Component:historylist`
> - `@C4-L3-Component:infobar`
> - `@C4-L3-Component:openuistatemanager`
> - `@C4-L3-Component:prototype-service`
> - `@C4-L3-Component:statemanager`
> - `@C4-L3-Component:statuscard`
...
### 1.2 提示词组装引擎 {#sec-12-tiu793au8bcdzuzhuangyinu64ce}
```
PromptAssembler
...
### 4.1 服务状态机 {#sec-41-u670dwuzhuangtaiji}
```mermaid
stateDiagram-v2
    [*] --> UNKNOWN: 初始化 / 未检测
...
### 4.2 降级触发条件 {#sec-42-jiangjiu89e6fau6761jian}
| 触发条件 | 降级目标 | 用户感知 |
|----------|----------|----------|
