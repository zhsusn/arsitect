...
title: DR-021：需求草图服务（PageSpec Sketch Service）模块详细设计
version: 1.0.0
...
> **C4 绑定引用**：
> - `@C4-Interface:GET /api/v1/sketches`
> - `@C4-Interface:GET /api/v1/stages/{stage_id}`
> - `@C4-Interface:GET /api/v1/stages/{stage_id}/annotations`
> - `@C4-Interface:GET /api/v1/stories`
> - `@C4-Interface:GET /api/v1/stories/{story_id}`
> - `@C4-Interface:POST /api/v1/sketches/generate`
> - `@C4-Interface:POST /api/v1/sketches/{sketch_id}/approve`
> - `@C4-Interface:POST /api/v1/sketches/{sketch_id}/regenerate`
> - `@C4-Interface:POST /api/v1/sketches/{sketch_id}/reject`
> - `@C4-Interface:POST /api/v1/sketches/{sketch_id}/review`
> - `@C4-Interface:POST /api/v1/stages/{stage_id}/annotations`
> - `@C4-L2-Container:frontend-spa`
> - `@C4-L3-Component:missingfielddialog`
> - `@C4-L3-Component:sketchreviewpanel`
> - `@C4-L3-Component:sketchstatemanager`
> - `@C4-L3-Component:sketchstatusmanager`
...
### 1.2 PageSpec 解析引擎 {#sec-12-pagespec-jiexiyinu64ce}
```
PageSpecParser
...
### 4.1 草图生命周期状态机 {#sec-41-u8349tushengu547dzhouqizhuang}
```mermaid
stateDiagram-v2
    [*] --> DRAFT: 草图任务创建
