...
title: DR-010：复杂度路由面板（Complexity Router Panel）模块详细设计
version: 1.0.0
...
> **C4 绑定引用**：
> - `@C4-Interface:GET /api/v1/artifacts/scan`
> - `@C4-Interface:GET /api/v1/complexity/decisions`
> - `@C4-Interface:GET /api/v1/complexity/paths`
> - `@C4-Interface:GET /api/v1/projects`
> - `@C4-Interface:GET /api/v1/projects/{project_id}`
> - `@C4-Interface:GET /api/v1/templates`
> - `@C4-Interface:GET /api/v1/templates/definitions`
> - `@C4-Interface:POST /api/v1/complexity/calculate`
> - `@C4-Interface:POST /api/v1/complexity/select-path`
> - `@C4-Interface:POST /api/v1/complexity/triage`
> - `@C4-L2-Container:frontend-spa`
> - `@C4-L3-Component:calibratepanel`
> - `@C4-L3-Component:complexitystatemanager`
> - `@C4-L3-Component:decisionlogdrawer`
> - `@C4-L3-Component:downgradeconfirmdialog`
> - `@C4-L3-Component:mismatchwarningbar`
> - `@C4-L3-Component:statemanager`
> - `@C4-L3-Component:triageresultcard`
...
### 1.2 五维度评估引擎 {#sec-12-wuweidupingguyinu64ce}
```
FiveDimensionEngine
...
### 4.1 路由面板会话状态机 {#sec-41-luyouu9762banu4f1au8bddzhuang}
```mermaid
stateDiagram-v2
    [*] --> Initializing: 进入面板
...
### 4.2 项目路径配置状态机 {#sec-42-u9879mulujingpeizhizhuangtaij}
```mermaid
stateDiagram-v2
    [*] --> Unconfigured: 项目创建初期
