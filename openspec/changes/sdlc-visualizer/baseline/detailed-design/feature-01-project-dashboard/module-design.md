...
> - `@C4-L3-Component:projectcard`
> - `@C4-L3-Component:projectrepository`
> - `@C4-L3-Component:projectservice`
> - `@C4-L3-Component:projecttimeboxrepository`
> - `@C4-L3-Component:riskalertrepository`
> - `@C4-L3-Component:riskscannerservice`
> - `@C4-L3-Component:templateservice`
> - `@C4-L3-Component:timeboxservice`
...
### 3.2 依赖公共表（引用说明） {#sec-32-yiu8d56u516cgongbiaoyinyongu8}
...
### 4.1 项目生命周期状态机 {#sec-41-u9879mushengu547dzhouqizhuang}
```mermaid
stateDiagram-v2
    [*] --> Draft: 创建项目
...
### 4.2 健康度卡片数据状态机 {#sec-42-u5065u5eb7duu5361u7247shujuzh}
```mermaid
stateDiagram-v2
...
### 4.3 风险预警生命周期 {#sec-43-fengxianyujingshengu547dzhouq}
```mermaid
stateDiagram-v2
    [*] --> Detected: 定时扫描触发（每小时）
