...
title: DR-011：C4 架构浏览器（C4 Architecture Navigator）模块详细设计
version: 1.0.0
...
> **C4 绑定引用**：
> - `@C4-Interface:GET /api/v1/artifacts/content`
> - `@C4-Interface:GET /api/v1/c4/dsl/{project_id}`
> - `@C4-Interface:POST /api/v1/c4/export`
> - `@C4-Interface:POST /api/v1/c4/generate`
> - `@C4-Interface:POST /api/v1/fs/open`
> - `@C4-Interface:PUT /api/v1/c4/dsl/{project_id}`
> - `@C4-Interface:PUT /api/v1/c4/dsl/{project_id}/{level}`
> - `@C4-Interface:PUT /api/v1/c4/nodes/{node_id}/file-mapping`
> - `@C4-L2-Container:frontend-spa`
> - `@C4-L2-Container:wireframe-engine`
> - `@C4-L3-Component:exportpanel`
> - `@C4-L3-Component:legendpanel`
> - `@C4-L3-Component:nodedetailsidepanel`
...
### 1.2 自动生成引擎 {#sec-12-zidongshengu6210yinu64ce}
```
C4AutoGenerator
...
### 4.1 DSL 层级状态机 {#sec-41-dsl-u5c42jizhuangtaiji}
```mermaid
stateDiagram-v2
...
### 4.2 层级导航状态机 {#sec-42-u5c42jidaohangzhuangtaiji}
```mermaid
stateDiagram-v2
    [*] --> L1: 默认进入
    L1 --> L2: 双击系统节点 / 面包屑切换
