...
title: DR-003：阶段详情面板（Stage Detail Panel）模块详细设计
version: 1.0.0
...
> **C4 绑定引用**：
> - `@C4-Interface:DELETE /api/v1/stages/{stage_id}/annotations/{annotation_id}`
> - `@C4-Interface:GET /api/v1/artifacts/{artifact_id}/content`
> - `@C4-Interface:GET /api/v1/executions/{execution_id}/logs`
...
> - `@C4-Interface:GET /api/v1/stages/{stage_id}/annotations`
> - `@C4-Interface:GET /api/v1/stages/{stage_id}/detail`
> - `@C4-Interface:GET /api/v1/stages/{stage_id}/versions`
> - `@C4-Interface:GET /api/v1/stages/{stage_id}/versions/diff`
> - `@C4-Interface:POST /api/v1/gates/{gate_id}/review`
> - `@C4-Interface:POST /api/v1/gates/{gate_id}/summary`
> - `@C4-Interface:POST /api/v1/stages/{stage_id}/annotations`
> - `@C4-Interface:POST /api/v1/stages/{stage_id}/regenerate`
> - `@C4-Interface:POST /api/v1/stages/{stage_id}/review/submit`
> - `@C4-Interface:POST /api/v1/stages/{stage_id}/versions/{version_number}/rollback`
> - `@C4-Interface:PUT /api/v1/artifacts/{artifact_id}/content`
> - `@C4-Interface:PUT /api/v1/stages/{stage_id}/annotations/{annotation_id}`
> - `@C4-Interface:WS /ws/executions/{execution_id}/logs`
> - `@C4-L2-Container:frontend-spa`
> - `@C4-L3-Component:annotationlayer`
> - `@C4-L3-Component:artifactcardstab`
> - `@C4-L3-Component:badgemanager`
> - `@C4-L3-Component:contentrouter`
> - `@C4-L3-Component:drawershell`
> - `@C4-L3-Component:executionlogstab`
> - `@C4-L3-Component:masklayer`
> - `@C4-L3-Component:pocketflowstatustab`
> - `@C4-L3-Component:qualitygatetab`
> - `@C4-L3-Component:resizehandle`
> - `@C4-L3-Component:reviewtab`
> - `@C4-L3-Component:skillsnapshottab`
> - `@C4-L3-Component:stagedetailpanel`
> - `@C4-L3-Component:statemanager`
> - `@C4-L3-Component:tabbar`
> - `@C4-L3-Component:tabcontroller`
> - `@C4-L3-Component:versionhistorysidebar`
...
### 1.2 六个 Tab 子组件 {#sec-12-liuge-tab-u5b50zujian}
| Tab | 组件名 | 核心职责 | 懒加载 |
|-----|--------|---------|--------|
...
### 1.3 审查 Tab 子组件 {#sec-13-shencha-tab-u5b50zujian}
```
ReviewTab
...
### 4.1 审查状态机（核心） {#sec-41-shenchazhuangtaijihexin}
```mermaid
stateDiagram-v2
...
### 4.2 产物版本状态机 {#sec-42-chanu7269banbenzhuangtaiji}
```mermaid
stateDiagram-v2
    [*] --> ACTIVE: 版本创建
...
### 4.3 面板 UI 状态机 {#sec-43-u9762ban-ui-zhuangtaiji}
```mermaid
stateDiagram-v2
    [*] --> CLOSED: 初始态
