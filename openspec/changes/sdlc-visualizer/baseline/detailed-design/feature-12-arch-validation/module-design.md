...
title: DR-012：架构验证中心（Architecture Validation Center）模块详细设计
version: 1.0.0
...
> **C4 绑定引用**：
> - `@C4-Interface:GET /api/v1/arch-validation/{project_id}/baseline`
> - `@C4-Interface:GET /api/v1/arch-validation/{project_id}/config`
> - `@C4-Interface:GET /api/v1/arch-validation/{project_id}/diffs`
> - `@C4-Interface:GET /api/v1/arch-validation/{project_id}/diffs/{diff_id}`
> - `@C4-Interface:GET /api/v1/arch-validation/{project_id}/scans`
> - `@C4-Interface:GET /api/v1/arch-validation/{project_id}/status`
> - `@C4-Interface:GET /api/v1/c4/dsl/{project_id}`
> - `@C4-Interface:GET /api/v1/c4/render-state`
> - `@C4-Interface:POST /api/v1/arch-validation/{project_id}/detect`
> - `@C4-Interface:POST /api/v1/arch-validation/{project_id}/export`
> - `@C4-Interface:PUT /api/v1/arch-validation/{project_id}/config`
> - `@C4-Interface:PUT /api/v1/c4/dsl/{project_id}`
> - `@C4-L2-Container:frontend-spa`
> - `@C4-L2-Container:sqlite-db`
> - `@C4-L3-Component:accuracywarningbar`
> - `@C4-L3-Component:archvalidationstore`
> - `@C4-L3-Component:baselineinfocard`
> - `@C4-L3-Component:difflist`
> - `@C4-L3-Component:exportmodal`
> - `@C4-L3-Component:filterbar`
> - `@C4-L3-Component:historylist`
> - `@C4-L3-Component:scanconfigmodal`
> - `@C4-L3-Component:scanhistorypanel`
...
### 1.2 差异计算核心引擎 {#sec-12-u5deeyijisuanhexinyinu64ce}
```
DiffEngine
...
### 4.1 检测会话状态机 {#sec-41-jianceu4f1au8bddzhuangtaiji}
```mermaid
stateDiagram-v2
    [*] --> Idle: 页面加载 / 会话结束
...
### 4.2 差异项状态机 {#sec-42-u5deeyiu9879zhuangtaiji}
```mermaid
stateDiagram-v2
    [*] --> Unconfirmed: 差异计算完成
...
### 5.3 性能与验收测试 {#sec-53-xingnengyuyanshouceshi}
| 指标 | 目标值 | 测试方法 |
|------|--------|----------|
