...
title: DR-004：审批中心（Gate Center）模块详细设计
version: 1.0.0
...
> - `@C4-Interface:GET /api/v1/gates/history`
> - `@C4-Interface:GET /api/v1/gates/history/export`
> - `@C4-Interface:GET /api/v1/gates/{gate_id}`
> - `@C4-Interface:GET /api/v1/quality-gate/results`
> - `@C4-Interface:GET /api/v1/stages/{stage_id}`
> - `@C4-Interface:GET /api/v1/stages/{stage_id}/annotations`
> - `@C4-Interface:GET /api/v1/stages/{stage_id}/downstream`
> - `@C4-Interface:POST /api/v1/ai/summary`
> - `@C4-Interface:POST /api/v1/bypass`
> - `@C4-Interface:POST /api/v1/gates/{gate_id}/approve`
> - `@C4-Interface:POST /api/v1/gates/{gate_id}/reject`
> - `@C4-Interface:POST /api/v1/gates/{gate_id}/retry`
> - `@C4-Interface:POST /api/v1/stages/{stage_id}/annotations`
> - `@C4-Interface:PUT /api/v1/stages/{stage_id}/review-status`
> - `@C4-Interface:PUT /api/v1/stages/{stage_id}/unlock`
> - `@C4-L2-Container:frontend-spa`
> - `@C4-L2-Container:sqlite-db`
> - `@C4-L3-Component:decisionpanel`
> - `@C4-L3-Component:filterbar`
> - `@C4-L3-Component:gatecardlist`
> - `@C4-L3-Component:gatestatemanager`
> - `@C4-L3-Component:selfcheckpanel`
...
### 1.2 自检摘要生成流程 {#sec-12-zijianzhaiyaoshengu6210liuu7a}
```
用户进入 Gate 详情页
    │
    ▼
...
### 4.1 Gate 决策状态机 {#sec-41-gate-juecezhuangtaiji}
```mermaid
stateDiagram-v2
    [*] --> 待审: 创建 Gate
    待审 --> 已通过: 通过 + 二次确认
...
### 4.2 决策按钮状态矩阵 {#sec-42-jueceanu94aezhuangtaiu77e9u96}
...
### 4.3 旁路审批子状态机 {#sec-43-u65c1lushenpiu5b50zhuangtaiji}
