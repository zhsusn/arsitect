...
title: DR-020：原型-架构双向绑定（Prototype-Architecture Bidirectional Binding）模块详细设计
version: 1.0.0
...
> - `@C4-Interface:GET /api/v1/coverage-scans/{scan_id}`
> - `@C4-Interface:GET /api/v1/coverage-scans/{scan_id}/writeback-preview`
> - `@C4-Interface:GET /api/v1/gates`
> - `@C4-Interface:GET /api/v1/openui/generations`
> - `@C4-Interface:GET /api/v1/projects`
> - `@C4-Interface:GET /api/v1/projects/{project_id}`
> - `@C4-Interface:GET /api/v1/projects/{project_id}/coverage-scans`
> - `@C4-Interface:GET /api/v1/wireframe/pages`
> - `@C4-Interface:PATCH /api/v1/coverage-scan-items/{item_id}/writeback`
> - `@C4-Interface:POST /api/v1/coverage-scan-items/{item_id}/review`
> - `@C4-Interface:POST /api/v1/coverage-scans/{scan_id}/writeback`
> - `@C4-Interface:POST /api/v1/gates/review`
> - `@C4-Interface:POST /api/v1/projects/{project_id}/coverage-scans`
> - `@C4-Interface:PUT /api/v1/c4/dsl/{project_id}`
> - `@C4-L3-Component:bindingpanel`
> - `@C4-L3-Component:bindingstatemanager`
...
### 1.2 检测引擎详解 {#sec-12-jianceyinu64cexiangjie}
```
BindingAnalyzer
...
### 4.1 检测报告生命周期 {#sec-41-jiancebaogaoshengu547dzhouqi}
```mermaid
stateDiagram-v2
    [*] --> running: 用户点击开始检测
...
### 4.2 扫描单项生命周期（MVP 简化版） {#sec-42-u626bu63cfdanu9879shengu547dz}
```mermaid
stateDiagram-v2
    [*] --> gap: 检测归类为缺失
...
### 4.3 接口定义状态（InterfaceContract 视角） {#sec-43-jiekouu5b9au4e49zhuangtaiinte}
```mermaid
stateDiagram-v2
...
### 5.3 性能测试（MVP 未执行，P1 补充） {#sec-53-xingnengceshimvp-weizhixingp1}
| 指标 | 目标值 | 测试方法 |
|------|--------|----------|
