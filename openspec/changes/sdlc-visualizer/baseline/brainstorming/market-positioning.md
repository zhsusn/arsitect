---
doc_type: "CHANGELOG"
fragment_id: "changelog-sdlc-visualizer-864"
title: "Market Positioning - sdlc-visualizer"
version: "1.0.0"
...
### Primary（直接竞品 — 提供 AI 工作流可视化或编排的平台） {#sec-primaryu76f4jieu7adeu54c1-tiu4f9}
...
### Secondary（相邻扩展 — 在部分场景可替代本项目的工具） {#sec-secondaryxiangu90bbu6269u5c55-za}
| 竞品 | 定位 | 核心能力 | 与本项目重叠度 | 证据层级 |
|------|------|----------|---------------|---------|
...
### Non-obvious（范式威胁 — 可能从根本上改变市场格局的力量） {#sec-nonobviousfanu5f0fu5a01u80c1-u53}
| 威胁源 | 描述 | 影响路径 | 证据层级 |
|--------|------|----------|---------|
...
## 4. 颠覆向量与威胁景观 {#sec-4-u98a0fuxiangliangyuu5a01u80c1j}
### H1（现有核心业务优化） {#sec-h1xianyouhexinyewuyouhua}
- **向量**：在超级个体市场中，通过极致的单人体验和本地优先策略，成为"AI 辅助开发可视化"品类的首选工具。
- **威胁**：Cursor 等 AI 原生 IDE 可能内置类似功能，直接截流用户。

### H2（邻近市场扩展） {#sec-h2u90bbu8fd1u5e02u573au6269u5c55}
- **向量**：从超级个体扩展到 3-5 人小团队，引入轻量协作（评论、共享产物、异步审批），切入小型创业公司市场。
- **威胁**：CrewAI Studio 或 Dify 团队版可能快速跟进小团队协作功能。

### H3（ transformative 创新） {#sec-h3-transformative-chuangxin}
...
### T5（高管声明/PR） {#sec-t5u9ad8guanu58f0u660epr}
