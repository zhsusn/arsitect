...
## 1. 系统架构 {#sec-1-xitongjiagou}
### 1.1 C4 Model — Context 图 {#sec-11-c4-model-context-tu}
```mermaid
flowchart TB
...
### 1.2 C4 Model — Container 图 {#sec-12-c4-model-container-tu}
```mermaid
flowchart TB
...
### 1.3 C4 Model — Component 图（后端核心） {#sec-13-c4-model-component-tuu540eu7a}
```mermaid
flowchart TB
...
### 1.4 业务功能架构图 {#sec-14-yewugongnengjiagoutu}
```mermaid
flowchart TD
...
## 2. 技术栈 {#sec-2-u6280u672fu6808}
### 2.1 选型清单 {#sec-21-xuanxingu6e05dan}
...
### 2.2 选型矩阵（关键争议项） {#sec-22-xuanxingu77e9u9635guanu952eu4}
...
### 2.3 关键架构决策（ADR） {#sec-23-guanu952ejiagoujueceadr}
...
## 3. 项目结构 {#sec-3-u9879mujiegou}
### 3.1 目录树 {#sec-31-muluu6811}
```
sdlc-visualizer/
...
### 3.2 目录职责说明表 {#sec-32-muluu804cu8d23u8bf4u660ebiao}
| 目录 | 对应架构层 | 允许内容 | 禁止内容 |
|------|-----------|----------|----------|
...
### 1.1 技术架构图（C4-Model：Context→Container→Component） {#sec-11-u6280u672fjiagoutuc4modelcont}
#### C4 Context（系统上下文）
...
### 1.2 业务功能架构图（模块划分图） {#sec-12-yewugongnengjiagoutumokuaihua}
```mermaid
graph TB
...
### 2.2 选型矩阵 {#sec-22-xuanxingu77e9u9635}
