...
> 版本：v1.0
> 日期：2026-06-01
> 来源类型：hybrid（本地历史文档为主，网络资料参考历史文档引用）
> 关联文档：requirement-draft.md、brainstorming-log.md

---

## 本地文档

### docs/brainstorming/requirement-draft.md（历史 v1.0）
...
### docs/high-level-requirements/00-requirements-overview.md（PRD v1.4-draft）
...
### docs/skill-studio-ui-spec.md（UI 规格书 V2.0）
...
### docs/skill-flow-yaml-schema.md（Schema V1.0）
