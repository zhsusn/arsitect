...
def upgrade() -> None:
    ...
    op.create_index(
        op.f('ix_config_nodes_node_type'), 'config_nodes', ['node_type'], unique=False
    )
    op.create_index(
        op.f('ix_config_nodes_scope'), 'config_nodes', ['scope'], unique=False
    )
    op.create_index(
        op.f('ix_config_nodes_scope_target'), 'config_nodes', ['scope_target'], unique=False
    )
    op.create_index(
        op.f('ix_config_nodes_key'), 'config_nodes', ['key'], unique=False
    )
    op.create_index(
