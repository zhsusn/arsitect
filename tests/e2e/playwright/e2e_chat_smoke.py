...
async def main() -> None:
    async with async_playwright() as p:
        ...
        await page.screenshot(path="../test-results/chat_home.png")
        ...
        await page.screenshot(path="../test-results/chat_session_connected.png")

        # Send another message in session page
        await page.fill('textarea', 'test message')
        await page.press('textarea', 'Enter')
        await page.wait_for_timeout(6000)
        await page.screenshot(path="../test-results/chat_session_replied.png")
